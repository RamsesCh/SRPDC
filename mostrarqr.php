                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    ?>
                        ...
                        <h5>Gracias por contestar el formulario de sanidad, presenta este código en la puerta de la Universidad para acceder de una manera más rápida y sencilla.</h5>
                    ...
                    ?>
                        ...
                        <h5>Gracias por contestar el formulario de sanidad, desafortunadamente se te negará el acceso a la institución.</h5>
                    <?php
                      }  
                    ?>
                  </div>
                </div>
                <a href="contestar_form.php" class="btn btn-outline-danger" style="float:right;">Finalizar</a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
