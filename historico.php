<?php 
  ...
  $permisos=$mysqli->query("SELECT * FROM rel_roles_modulos WHERE id_rol = '$id_rol' and id_modulo = '5'");
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <h3>Histórico Alumnos</h3><br>
                <table class="table table-bordered table-hover" id="example2" style="overflow:auto; display:inline-block;">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Matrícula</th>
                        ...
                        <?php
                          ...
                          $consulta=$mysqli->query("SELECT * FROM historial_alumnos");
                          $cont=1;
                        ...
                        ?>
                             <tr>
                                ...
                                <td style="color: <?php if($datos['temperatura'] > 40 ){ echo 'red'; }?>"><?php echo $datos['temperatura']?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">REPORTE PERSONALIZADO</h4>
            ...
            <div class="modal-body">
              <form id="formadd">
                  ...
                  <input type="date" class="form-control" id="fecha1" required><br>
                  <label for="">Fecha de Fin*</label>
                  <input type="date" class="form-control" id="fecha2" required><br>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Cancelar</button>
              <button type="button" class="btn btn-outline-success" id="btnadd" onclick="agregar_user();">Generar</button>
            </div>
            </form>
        </div>
          <!-- /.modal-content -->
